...
# Frame-by-frame state (coarser sampling -- this is what actually gets animated),
# also spanning all N_PERIODS periods.
t_frames = np.linspace(0, N_PERIODS * P, N_FRAMES * N_PERIODS, endpoint=False)
...
ani = animation.FuncAnimation(fig, update, frames=N_FRAMES * N_PERIODS, interval=1000 / FPS, blit=False)
